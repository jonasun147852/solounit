...
If `${CLAUDE_PLUGIN_ROOT}` did not expand, locate the repo copy at `the oneco CLI from your clone of this repo (tools/oneco/bin/oneco.mjs)` and run that instead. Everything is local; no network is involved.
