...
Run this exact command with the Bash tool and show the user its full output unmodified. Requires --url or ONECO_HUB_URL; if unset, show the user the instructions the command prints.
